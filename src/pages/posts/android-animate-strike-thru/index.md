...
<Video src="strike_thru_the_heart.mov" width="376" height="400" />
...
<Video src="color_transition.*" ext=".webm,.m4v" width="295" height="300" />
...
<img src="square_line_with_dots.png" alt="Square line with dots" width="394" height="400">
...
<Video src="square_line_transition.*" ext=".webm,.m4v" width="800" height="257" />
...
<Video src="curved_line_no_mask.*" ext=".webm,.m4v" width="800" height="258" />
...
<Video src="curved_line_with_mask.*" ext=".webm,.m4v" width="301" height="300" />

### The spacing

If we put our animated line on top of another icon, this is what we end up with.

<Video src="line_no_gap_2.*" ext=".webm,.m4v" width="298" height="300" />
...
<img src="static_icon_with_gap.png" alt="Static icon with line through it and a gap" width="295" height="300">
...
<Video src="mask_transition.*" ext=".webm,.m4v" width="297" height="300" />
...
<Video src="complete_animation.*" ext=".webm,.m4v" width="306" height="300" />
...
<GitHub repo="NotWoods/android-strikethru-animation-sample" />
...
<Video src="sample_preview.*" ext=".webm,.m4v" width="640" height="538" />
