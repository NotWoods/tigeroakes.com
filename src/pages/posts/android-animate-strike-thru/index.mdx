...
export { default as banner } from './static_icon_with_gap.png';
...
<img
  src="square_line_with_dots.png"
  alt="Square line with dots"
  width="394"
  height="400"
/>
...
![SVG emoji + clip path = SVG emoji with clip path applied](/posts/android-animate-strike-thru/svg_mask.png)

By using a clip path, we can hide the end of the line without changing the relative positioning of its dots.

<Video
  src="curved_line_with_mask.*"
  ext=".webm,.m4v"
  width="301"
  height="300"
/>
...
<img
  src="static_icon_with_gap.png"
  alt="Static icon with line through it and a gap"
  width="295"
  height="300"
/>
