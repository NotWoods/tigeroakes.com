...
description: Slightly confusing conditions around Jest module mocks.
date: 2022-12-27
lastMod: 2024-07-07
tags:
  - Web
...
```tsx
// module-to-test1.test.ts
import { functionToTest } from './module-to-test1';
...
function getMocksForTest() {
  ...
  const { functionToTest } =
    require('./module-to-test2') as typeof import('./module-to-test2');
...
```tsx
// module-to-test2.test.ts
import { functionToTest } from './module-to-test2';
