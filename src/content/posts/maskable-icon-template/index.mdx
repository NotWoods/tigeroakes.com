...
links:
  - title: Download
    link: /posts/maskable-icon-template/maskable_icon_template.afdesign
images:
  - /posts/maskable-icon-template/affinity-designer.png
banner: ./affinity-designer.png
---

export { default as banner } from './affinity-designer.png';
...
[**Maskable Icon Template**](/posts/maskable-icon-template/maskable_icon_template.afdesign)
