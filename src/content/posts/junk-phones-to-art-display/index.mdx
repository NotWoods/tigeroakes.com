...
<img
  src="cell-wall-graphic-decorated.svg"
  alt="Example of CellWall running with different screens"
  width="837"
  height="618"
/>
...
If the phone does turn on, [enable developer mode](https://developer.android.com/studio/debug/dev-options). Open settings, open the System section, and go to "About phone". Developer mode is hidden here - by tapping on "Build number" many times, you eventually get a prompt indicating you are now a true Android developer.
