...
import { VariableFontSliders } from '../../../components/demos/segoe-ui-variable/VariableFontSliders.tsx';
...
![Screenshot of Windows 11 font settings, showing entries for "Segoe UI" and "Segoe UI Variable"](/posts/segoe-ui-variable/font-settings-windows-11.png)
...
| Small | Text | Display |
| --- | --- | --- |
| ![Preview of Segoe UI Variable Small](/posts/segoe-ui-variable/typography_caption.svg) | ![Preview of Segoe UI Variable Text](/posts/segoe-ui-variable/typography_body.svg) | ![Preview of Segoe UI Variable Display](/posts/segoe-ui-variable/typography_title.svg) |
