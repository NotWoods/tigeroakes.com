...
![Homescreen with icons inside white circles](/posts/maskable-icons/launcher_screenshot.png)
...
![Icons restricted to different shapes](/posts/maskable-icons/manufactuers.png)
