...
![Folder containing icons with transparent backgrounds or solid backgrounds](/posts/maskable-icons/folder.png)

But, if you have a recent Android phone, your icons will show up like this:

![Home screen with icons inside white circles](/posts/maskable-icons/launcher_screenshot.png)
...
![Icons of various shapes and sizes](/posts/maskable-icons/freeform.png)
...
![Icons restricted to different shapes](/posts/maskable-icons/manufacturers.png)
...
![Icons stuck in shapes with white backgrounds](/posts/maskable-icons/white_bg.png)
...
![Icons with detailed backgrounds restricted to different shapes](/posts/maskable-icons/masked.png)
