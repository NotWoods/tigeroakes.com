...
![Sidebar menu with no routes displayed](/posts/eleventy-bus-app-experiment/empty_menu.png)
...
![Sidebar menu displaying routes](/posts/eleventy-bus-app-experiment/populated_menu.png)
...
```handlebars title="_data/api.json.njk"
---
permalink: /api.json
---
{{ api | dump | safe }}
